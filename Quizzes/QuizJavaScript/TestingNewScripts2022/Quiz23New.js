...
name: "<b>Question 2</b>",
choicesOrder: "random",
title: `The general recurrence relation, $p_k/p_{k-1} = a + \\frac{b}{k}, k \\ge 1$, ties together the three distributions, the binomial, the Poisson and the negative binomial distributions. If $a = 0$ and $b > 0$, we get a:`,
cellType: "html",
choices: [
"Binomial distribution",
"Negative binomial distribution",
...
name: "<b>Question 3</b>",
choicesOrder: "random",
title: 'The general recurrence relation, $p_k/p_{k-1} = a + \\frac{b}{k}, k \\ge 1$, ties together the three distributions, the binomial, the Poisson and the negative binomial distributions. If $a > 0$, and $a+b > 0$ (or equivalently $b=(r−1)a$ with $r>0$), we get a:',
cellType: "html",
choices: [
"Binomial distribution",
"Poisson distribution",
...
$(function() {
    $("#surveyResult23").Survey({ model: survey23 });
});
...
window.survey = new Survey.Model(json23);
survey
    .onComplete
    .add(function (result) {
        document
